        ...
        <div className="sm:px-6 max-w-[70ch] mx-auto">
          ...
          <div className="italic text-purple-dark bg-purple-200/75 shadow-[0_0_20px_10px_rgb(233,213,255)] space-y-2">
            <p>
              ...
              wyznacz drogę, którą naprawdę chcesz podążać. Wyznacz realne cele,
              zadbaj o swoje granice, ustal normy, którymi chcesz żyć na co
              dzień.
            </p>
            <p>
              Dzięki udziałowi w programie otrzymasz wsparcie i motywację, które
              pomogą Ci ruszyć z miejsca. Dostaniesz sprawdzone metody i
        ...
        description={
          <div className="space-y-4">
            <p>
              ...
              oskarżanie, problemy z komunikacją i niezadowolenie stało się moją
              codziennością. Po narodzinach pierwszego dziecka zaczęłam
              gruntowną pracę nad przekonaniami, schematami i komunikacją, co w
              ciągu zaledwie kilku lat kompletnie odmieniło moje życie.
            </p>
            <p>
              ...
              komunikacyjne i myślowe sprawiały, że zamiast relacji budowałam z
              moim mężem mur. Udało się go zburzyć i mogę pokazać Ci jak to
              zrobić!
            </p>
            <p>
              Prowadzę Akademię bliskich relacji, w której pokazuję jak budować
              relacje i komunikować się w rodzinie. Pomagam w zrozumieniu siebie
              samego i pokazuję jak bardzo codzienne relacje i komunikaty
              wpływają na jakość życia. Stworzyłam autorskie kursy i wyzwania
              rozwojowe o budowaniu dobrych relacji i rozwiązywaniu konfliktów,
              w których wzięło udział już ponad 1000 osób! Mam na swoim koncie
              dziesiątki godzin konsultacji z zadowolonymi klientkami.
            </p>
            <p>
    ...
    <Section
      ...
      description={
        <p className="max-w-prose mx-auto">
          Tematy, które będę poruszać i problemy, nad którymi będziemy wspólnie
          pracować, są uniwersalne i fundamentalne do tego, żeby zbudować dobrą
          relację z partnerem! Możesz dołączyć do kursu niezależnie od Twojego
          stopnia zadowolenia z relacji. Pomogę Ci zmienić perspektywę i dam
            ...
            description: (
              <div className="space-y-4">
                <div className="text-sm space-y-1">
                  ...
                  <p>
                    - Określisz swoje cele, które chcesz osiągnąć w programie i
                    rzeczy nad którymi chcesz pracować.
                  </p>
                </div>
                ...
                <div className="text-sm space-y-1">
                  ...
                  <p>
                    ...
                    sprawczość w budowaniu swojej relacji. Dowiesz się, dlaczego
                    warto odrzucić niektóre wymagania i zastąpić je normami.
                    Przyjrzysz się temu jak działają Twoje granice i uszczelnisz
                    je w najbardziej kruchych miejscach. Zyskasz również
                    motywację do tego, żeby brać odpowiedzialność za swoją część
                    w relacji.
                  </p>
                </div>
